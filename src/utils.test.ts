...
describe('resolveRelativeUrl', () => {
  ...
  it('resolves path with subfolder base', () => {
    expect(resolveRelativeUrl('note.html', { baseUrl: '/Markdown-Notes/' })).toBe(
      'https://example.com/Markdown-Notes/note.html'
    );
  });
  ...
  it('handles absolute-like paths by prefixing with base', () => {
    expect(resolveRelativeUrl('sub/page.html', { baseUrl: '/app/' })).toBe(
      'https://example.com/app/sub/page.html'
    );
  });
  ...
  it('handles root-relative input path by ignoring base (URL standard behavior)', () => {
    ...
    expect(resolveRelativeUrl('/root.html', { baseUrl: '/app/' })).toBe(
